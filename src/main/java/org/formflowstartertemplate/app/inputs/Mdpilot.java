...
public class Mdpilot extends FlowInputs {

  private MultipartFile mdpilotFiles;
  ...
  @NotEmpty(message = "{benefitOptions.choice-error")
  private ArrayList<String> benefitElection;
